<template>
  <div>
    <section class="mx-auto my-20 container flex items-center justify-between">
      ...
      <section class="bg-secondary w-[20%] p-5 flex flex-col justify-between rounded-md text-primary">
        ...
        <button class="flex border-primary border justify-center rounded-md p-1 hover:text-gray" @click="saveToCart">
